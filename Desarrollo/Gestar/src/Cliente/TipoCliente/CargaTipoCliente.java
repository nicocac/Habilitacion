 ...
 */
public class CargaTipoCliente extends JFrame {
    ...
    public CargaTipoCliente() {
    }

    public CargaTipoCliente(String operacion, String nombre, String descripcion, int id) {
        ...
        if (tipoOperacion.equals("Carga")) {
            this.setTitle("Cargar Tipo de Cliente");
        } else {
            this.setTitle("Modificar Tipo de Cliente");
        }
        ...
        guardarButton.addActionListener(e -> {
            if (save()) {
                JOptionPane.showMessageDialog(null, "Se guardo correctamente el tipo Cliente: " + txtNombre.getText());
                dispose();
            }
        });
...
//            session.close();
                ...
                JOptionPane.showMessageDialog(this, "Ocurrio un error al guardar el tipo de Cliente: " + e.toString());
            } finally {
                session.close();
            }
        } else {
